...
public class MyText extends Activity implements OnTouchListener, OnClickListener {//我的贴子
    /** 
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//侧栏相关
		        ...
		        broadsearch = (TextView)findViewById(R.id.broadsearch7);
		        broadsearch.setOnClickListener(this);
		        broadpost = (TextView)findViewById(R.id.broadpost7);
		        broadpost.setOnClickListener(this);
		        broadmylike = (TextView)findViewById(R.id.broadmylike7);
		        broadmylike.setOnClickListener(this);
		        broadmyinfo = (TextView)findViewById(R.id.broadmyinfo7);
		        broadmyinfo.setOnClickListener(this);
		        broadmytext = (TextView)findViewById(R.id.broadmytext7);
		        broadmytext.setOnClickListener(this);
		        broadset = (TextView)findViewById(R.id.broadset7);
		        broadset.setOnClickListener(this);
		        broadmychat = (TextView)findViewById(R.id.broadmychat7);
		        broadmychat.setOnClickListener(this);
		        broadabout = (TextView)findViewById(R.id.broadabout7);
...
//			      
			      LinearLayout.LayoutParams lp2 = new LinearLayout.LayoutParams(  
					...
					scrollview=(ScrollView)findViewById(R.id.scrollview7);
//					
//					setLayout(scrollview,(int)(20/480.0*width),
//							(int)(225/800.0*height));

			      
			      LinearLayout body = (LinearLayout) findViewById(R.id.body7);
...
//						tv.setText("Test" + i+"Test" + i+"Test" + i+"Test" + i+"Test" + i+"Test" + i+"Test" + i);	
					  ...
					  ts = new Trans();
				        ...
				        TransBack tb = ts.mytext(FirstActivity.stuid);
	...
	*/ 
    ...
    private void initValues() {  
        ...
        content = findViewById(R.id.content7);  
	...
	public void onClick(View v) {
		...
		//####### 没有为mytext我的贴子的贴子添加去贴子详情和修改贴子的监听，将来可以考虑添加
		 ...
		 if(v == broadsearch){
			...
			intenttourist.putExtra("iam", "mytextfrombroad");

	    	intenttourist.setClass(MyText.this, SearchOne.class);
	    	MyText.this.startActivity(intenttourist);
		}
else if(v == broadpost){
		//去发帖页面
	Intent intentpost = new Intent();	
	System.out.println("iiiiiiiiiintent2");
	intentpost.setClass(MyText.this, Post.class);
	MyText.this.startActivity(intentpost);
		}
else if(v == broadmychat){
	//去查看消息

	Intent intenttomychat = new Intent();	
	intenttomychat.setClass(MyText.this, MyChat.class);
	MyText.this.startActivity(intenttomychat);
}
else if(v == broadmylike){
	//去看我的收藏
	Intent intenttocollect = new Intent();	
	System.out.println("iiiiiiiiiintent2");
	intenttocollect.setClass(MyText.this, MyCollect.class);
	MyText.this.startActivity(intenttocollect);
}
else if(v == broadmytext){
//本页
}
else if(v == broadabout){
	AlertDialog.Builder builder  = new Builder(MyText.this);
	...
	System.out.println("iiiiiiiiiintent2");
	intenttomyinfo.setClass(MyText.this, MyInfo.class);
	MyText.this.startActivity(intenttomyinfo);
}
else if(v == broadset){
//去设置
}
...
public boolean onKeyDown(int keyCode, KeyEvent event){
	if (keyCode == KeyEvent.KEYCODE_BACK
		...
		intentback.setClass(MyText.this, SearchOne.class);
		MyText.this.startActivity(intentback);
